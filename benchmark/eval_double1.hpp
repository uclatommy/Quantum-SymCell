...
TEST_F(BenchmarkSymEngine, eval_double)
{
    ...
    {
        e = pow(add(mul(add(sin(integer(1)), pow(i2, integer(-3))), integer(3)), integer(1)), div(integer(2), integer(3)));
    }

//  Too long:
//  std::cout<<timerString << "Evaluating: " << *e << std::endl;
